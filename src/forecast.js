...
//    if (props.ready === true) hour0 = getHours(new Date(props.dataReturned.data.list[0].dt * 1000)); let hourx = new Date();
    ...
    if (props.dataReturned.ready === true) {
        ...
        minTemp1 = props.dataReturned.data.list[1].main.temp_min;
        maxTemp1 = props.dataReturned.data.list[1].main.temp_max;
    ...
    if (props.dataReturned.ready === true) {
        ...
        minTemp2 = props.dataReturned.data.list[2].main.temp_min;
        maxTemp2 = props.dataReturned.data.list[2].main.temp_max;
    ...
    if (props.dataReturned.ready === true) {
        ...
        minTemp3 = props.dataReturned.data.list[3].main.temp_min;
        maxTemp3 = props.dataReturned.data.list[3].main.temp_max;
